# Matriz de remediación — v0.4.0-alpha.5
...
| H-01 | Metadatos obsoletos | Metadatos activos sincronizados a `v0.4.0-alpha.5`. | Validador recorre los artefactos activos. |
