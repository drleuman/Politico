-- ============================================================================
-- Migración DDL Incrementada Forward-Only — Política Canon v0.3.22
-- Fase 1.1 Funcional Remediada: Políticas RLS, Outbox de Correo, Revocación Transaccional e Índices
-- ============================================================================
...
-- 2. TABLA OUTBOX TRANSACCIONAL DE CORREO ELECTRÓNICO (C-03)
...
ALTER INDEX idx_email_outbox_pending OWNER TO app_owner;
