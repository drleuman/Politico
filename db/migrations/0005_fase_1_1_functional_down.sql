-- ============================================================================
-- Reversión de Migración DDL — Política Canon v0.3.22 (0005_fase_1_1_functional_down.sql)
...
-- 2. ELIMINAR TABLA OUTBOX Y FUNCIÓN SECURITY DEFINER CREADAS EN 0005
DROP TABLE IF EXISTS email_outbox CASCADE;
DROP FUNCTION IF EXISTS revoke_all_user_sessions_sec(UUID);

-- 3. ELIMINAR ÍNDICES CREADOS EN 0005
