# Script de Generación de Zip con Entradas POSIX (v0.2.10)
$zipName = "politica-canon-v0.2.10.zip"
$rootDir = "politica-canon-v0.2.10"
...
Write-Host "ZIP v0.2.10 creado exitosamente con separadores POSIX '/': $zipName"
