# Script de Generación de Zip y Manifiesto Externo Desacoplado (v0.2.12)
$zipName = "politica-canon-v0.2.12.zip"
$rootDir = "politica-canon-v0.2.12"
$parentZipPath = "..\politica-canon-v0.2.12.zip"
$parentManifestPath = "..\MANIFEST_v0.2.12.json"
$localManifestPath = "MANIFEST_v0.2.12.json"
...
Write-Host "ZIP v0.2.12 creado exitosamente con separadores POSIX '/': $zipName"
...
Write-Host "Manifiesto externo MANIFEST_v0.2.12.json generado exitosamente fuera del ZIP."
