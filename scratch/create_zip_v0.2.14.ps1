# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo Desacoplado (v0.2.14)
$zipName = "politica-canon-v0.2.14.zip"
$rootDir = "politica-canon-v0.2.14"
$parentZipPath = "..\politica-canon-v0.2.14.zip"
$parentManifestPath = "..\MANIFEST_v0.2.14.json"
$localManifestPath = "MANIFEST_v0.2.14.json"
...
Write-Host "ZIP v0.2.14 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
Write-Host "Manifiesto externo MANIFEST_v0.2.14.json generado exitosamente fuera del ZIP."
