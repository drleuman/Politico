# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo Desacoplado (v0.2.15)
$zipName = "politica-canon-v0.2.15.zip"
$rootDir = "politica-canon-v0.2.15"
$parentZipPath = "..\politica-canon-v0.2.15.zip"
$parentManifestPath = "..\MANIFEST_v0.2.15.json"
$localManifestPath = "MANIFEST_v0.2.15.json"
...
$fixedTime = [System.DateTimeOffset]::Parse("2026-09-15T20:00:00+02:00")
...
Write-Host "ZIP v0.2.15 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
Write-Host "Manifiesto externo MANIFEST_v0.2.15.json generado exitosamente fuera del ZIP."
