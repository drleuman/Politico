# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo Desacoplado (v0.2.17)
$zipName = "politica-canon-v0.2.17.zip"
$rootDir = "politica-canon-v0.2.17"
$parentZipPath = "..\politica-canon-v0.2.17.zip"
$parentManifestPath = "..\MANIFEST_v0.2.17.json"
$localManifestPath = "MANIFEST_v0.2.17.json"
...
Write-Host "ZIP v0.2.17 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
Write-Host "Manifiesto externo MANIFEST_v0.2.17.json generado exitosamente fuera del ZIP."
