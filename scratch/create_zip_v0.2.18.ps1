# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo Desacoplado (v0.2.18)
$zipName = "politica-canon-v0.2.18.zip"
$rootDir = "politica-canon-v0.2.18"
$parentZipPath = "..\politica-canon-v0.2.18.zip"
$parentManifestPath = "..\MANIFEST_v0.2.18.json"
$localManifestPath = "MANIFEST_v0.2.18.json"
...
Write-Host "ZIP v0.2.18 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
Write-Host "Manifiesto externo MANIFEST_v0.2.18.json generado exitosamente fuera del ZIP."
