# Script de Generación de Zip con Entradas POSIX (v0.2.8)
$zipName = "politica-canon-v0.2.8.zip"
$rootDir = "politica-canon-v0.2.8"
...
Write-Host "ZIP v0.2.8 creado exitosamente con separadores POSIX '/': $zipName"
