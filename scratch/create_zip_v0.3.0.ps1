# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo (v0.3.0)
$zipName = "politica-canon-v0.3.0.zip"
$rootDir = "politica-canon-v0.3.0"
$parentZipPath = "..\politica-canon-v0.3.0.zip"
$parentManifestPath = "..\MANIFEST_v0.3.0.json"
$localManifestPath = "MANIFEST_v0.3.0.json"
...
Write-Host "ZIP v0.3.0 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.0 REMEDIADO Y LISTO PARA REAUDITORÍA EXTERNA)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.0.json generado exitosamente."
