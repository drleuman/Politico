# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo (v0.3.1)
$zipName = "politica-canon-v0.3.1.zip"
$rootDir = "politica-canon-v0.3.1"
$parentZipPath = "..\politica-canon-v0.3.1.zip"
$parentManifestPath = "..\MANIFEST_v0.3.1.json"
$localManifestPath = "MANIFEST_v0.3.1.json"
...
Write-Host "ZIP v0.3.1 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.1 REMEDIADO Y LISTO PARA DESPLIEGUE SEGURO)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.1.json generado exitosamente."
