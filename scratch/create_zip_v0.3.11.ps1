# Script de Generacion de Zip Criptograficamente Determinista y Manifiesto Externo (v0.3.11)
$zipName = "politica-canon-v0.3.11.zip"
$rootDir = "politica-canon-v0.3.11"
$parentZipPath = "..\politica-canon-v0.3.11.zip"
$parentManifestPath = "..\MANIFEST_v0.3.11.json"
$localManifestPath = "MANIFEST_v0.3.11.json"
...
Write-Host "ZIP v0.3.11 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.11 MODELO DE GRUPOS RESTRINGIDO 0750/0640 B-02, NO BOM UTF-8 Y VERSION LOGS CORREGIDOS)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.11.json generado exitosamente (UTF-8 sin BOM)."
