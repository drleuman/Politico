# Script de Generacion de Zip Criptograficamente Determinista y Manifiesto Externo (v0.3.12)
$zipName = "politica-canon-v0.3.12.zip"
$rootDir = "politica-canon-v0.3.12"
$parentZipPath = "..\politica-canon-v0.3.12.zip"
$parentManifestPath = "..\MANIFEST_v0.3.12.json"
$localManifestPath = "MANIFEST_v0.3.12.json"
...
Write-Host "ZIP v0.3.12 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.12 FASE 1.1 IDENTIDAD INVITACIONES USUARIOS SESIONES Y RBAC/ABAC, NO BOM UTF-8)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.12.json generado exitosamente (UTF-8 sin BOM)."
