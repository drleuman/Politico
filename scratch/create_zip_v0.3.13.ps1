# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo (v0.3.13)
$zipName = "politica-canon-v0.3.13.zip"
$rootDir = "politica-canon-v0.3.13"
$parentZipPath = "..\politica-canon-v0.3.13.zip"
$parentManifestPath = "..\MANIFEST_v0.3.13.json"
$localManifestPath = "MANIFEST_v0.3.13.json"
...
Write-Host "ZIP v0.3.13 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.13 FASE 1.1 CORRECTIVA - ENDURECIMIENTO DE SEGURIDAD, NO BOM UTF-8)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.13.json generado exitosamente (UTF-8 sin BOM)."
