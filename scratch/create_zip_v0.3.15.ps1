# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo (v0.3.15)
$zipName = "politica-canon-v0.3.15.zip"
$rootDir = "politica-canon-v0.3.15"
$parentZipPath = "..\politica-canon-v0.3.15.zip"
$parentManifestPath = "..\MANIFEST_v0.3.15.json"
$localManifestPath = "MANIFEST_v0.3.15.json"
...
Write-Host "ZIP v0.3.15 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.15 FASE 1.1 CORRECTIVA - RESOLUTORES FORCE RLS, PROPIEDAD TOKEN_RESOLVER Y CONTROLES MFA ESTRICTOS, NO BOM UTF-8)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.15.json generado exitosamente (UTF-8 sin BOM)."
