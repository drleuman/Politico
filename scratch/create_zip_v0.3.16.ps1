# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo (v0.3.16)
$zipName = "politica-canon-v0.3.16.zip"
$rootDir = "politica-canon-v0.3.16"
$parentZipPath = "..\politica-canon-v0.3.16.zip"
$parentManifestPath = "..\MANIFEST_v0.3.16.json"
$localManifestPath = "MANIFEST_v0.3.16.json"
...
Write-Host "ZIP v0.3.16 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.16 FASE 1.1 CORRECTIVA - ALINEACION SCRIPTS DESPLIEGUE PACKAGE.JSON, PROPIEDAD TOKEN_RESOLVER Y CONTROLES MFA ESTRICTOS, NO BOM UTF-8)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.16.json generado exitosamente (UTF-8 sin BOM)."
