# Script de Generacion de Zip Criptograficamente Determinista y Manifiesto Externo (v0.3.17)
$zipName = "politica-canon-v0.3.17.zip"
$rootDir = "politica-canon-v0.3.17"
$parentZipPath = "..\politica-canon-v0.3.17.zip"
$parentManifestPath = "..\MANIFEST_v0.3.17.json"
$localManifestPath = "MANIFEST_v0.3.17.json"
...
Write-Host "ZIP v0.3.17 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE CANDIDATE V0.3.17 - NORMALIZACION CRLF E INMUTABILIDAD DE ARTEFACTOS)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.17.json generado exitosamente (UTF-8 sin BOM)."
