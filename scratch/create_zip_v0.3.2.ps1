# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo (v0.3.2)
$zipName = "politica-canon-v0.3.2.zip"
$rootDir = "politica-canon-v0.3.2"
$parentZipPath = "..\politica-canon-v0.3.2.zip"
$parentManifestPath = "..\MANIFEST_v0.3.2.json"
$localManifestPath = "MANIFEST_v0.3.2.json"
...
Write-Host "ZIP v0.3.2 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.2 REMEDIADO Y LISTO PARA DESPLIEGUE SEGURO EN PLESK)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.2.json generado exitosamente."
