# Script PowerShell para la creación determinista de politica-canon-v0.3.23.zip
$ErrorActionPreference = "Stop"

$version = "0.3.23"
$zipName = "politica-canon-v0.3.23.zip"
$rootDir = "politica-canon-v0.3.23"
$manifestName = "MANIFEST_v0.3.23.json"
...
$includes = @(
    ...
    "REMEDIATION_MATRIX_v0.3.23.md",
    "VALIDATION_REPORT_v0.3.23.md",
    "validate_v0.3.23.cjs",
...
Write-Host "ZIP v0.3.23 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObj = [ordered]@{
    ...
    dictamen = "PASS (RELEASE CANDIDATE V0.3.23 - FASE 1.1 FUNCIONAL REMEDIADA Y CERTIFICADA)"
}
