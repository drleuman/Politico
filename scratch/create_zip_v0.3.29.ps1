# Script PowerShell para la creación determinista de politica-canon-v0.3.29.zip y RELEASE_FILES.json
$ErrorActionPreference = "Stop"

$version = "0.3.29"
$zipName = "politica-canon-v0.3.29.zip"
$rootDir = "politica-canon-v0.3.29"
$manifestName = "MANIFEST_v0.3.29.json"
...
$includes = @(
    ...
    "REMEDIATION_MATRIX_v0.3.29.md",
    "VALIDATION_REPORT_v0.3.29.md",
    "validate_v0.3.29.cjs",
...
# Generar RELEASE_FILES.json con hashes SHA-256 individuales de todo el árbol (M-04 Integridad de Árbol Extraído)
...
Write-Host "ZIP v0.3.29 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObj = [ordered]@{
    ...
    dictamen = "PASS (RELEASE CANDIDATE V0.3.29 - FASE 1.1 FUNCIONAL REMEDIADA Y CERTIFICADA)"
}
