# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo (v0.3.5)
$zipName = "politica-canon-v0.3.5.zip"
$rootDir = "politica-canon-v0.3.5"
$parentZipPath = "..\politica-canon-v0.3.5.zip"
$parentManifestPath = "..\MANIFEST_v0.3.5.json"
$localManifestPath = "MANIFEST_v0.3.5.json"
...
Write-Host "ZIP v0.3.5 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.5 REMEDIADO Y LISTO PARA DESPLIEGUE SEGURO EN PLESK)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.5.json generado exitosamente."
