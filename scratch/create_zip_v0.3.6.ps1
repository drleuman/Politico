# Script de Generación de Zip Criptográficamente Determinista y Manifiesto Externo (v0.3.6)
$zipName = "politica-canon-v0.3.6.zip"
$rootDir = "politica-canon-v0.3.6"
$parentZipPath = "..\politica-canon-v0.3.6.zip"
$parentManifestPath = "..\MANIFEST_v0.3.6.json"
$localManifestPath = "MANIFEST_v0.3.6.json"
...
Write-Host "ZIP v0.3.6 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.6 REMEDIADO Y LISTO PARA DESPLIEGUE SEGURO EN PLESK)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.6.json generado exitosamente."
