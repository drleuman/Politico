# Script de Generacion de Zip Criptograficamente Determinista y Manifiesto Externo (v0.3.7)
$zipName = "politica-canon-v0.3.7.zip"
$rootDir = "politica-canon-v0.3.7"
$parentZipPath = "..\politica-canon-v0.3.7.zip"
$parentManifestPath = "..\MANIFEST_v0.3.7.json"
$localManifestPath = "MANIFEST_v0.3.7.json"
...
Write-Host "ZIP v0.3.7 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.7 EVIDENCIA DE INTEGRACION PG16 / REDIS VALIDADA Y LISTO PARA DESPLIEGUE SEGURO EN PLESK)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.7.json generado exitosamente."
