# Script de Generacion de Zip Criptograficamente Determinista y Manifiesto Externo (v0.3.9)
$zipName = "politica-canon-v0.3.9.zip"
$rootDir = "politica-canon-v0.3.9"
$parentZipPath = "..\politica-canon-v0.3.9.zip"
$parentManifestPath = "..\MANIFEST_v0.3.9.json"
$localManifestPath = "MANIFEST_v0.3.9.json"
...
Write-Host "ZIP v0.3.9 creado exitosamente (DETERMINISTA) con separadores POSIX '/': $zipName"
...
$manifestObject = [PSCustomObject]@{
    ...
    dictamen = "PASS (RELEASE V0.3.9 INTEGRACION DIRECTA EN NPM TEST, STRICT FAIL CLOSED Y LIMPIEZA FINALLY ENTORNO PLESK)"
}
...
Write-Host "Manifiesto externo MANIFEST_v0.3.9.json generado exitosamente."
