# Script PowerShell para la creación determinista e inmutable de politica-canon-v0.4.0-alpha.2.zip y MANIFEST_v0.4.0-alpha.2.json
$ErrorActionPreference = "Stop"

$version = "0.4.0-alpha.2"
$zipName = "politica-canon-v0.4.0-alpha.2.zip"
$rootDir = "politica-canon-v0.4.0-alpha.2"
$manifestName = "MANIFEST_v0.4.0-alpha.2.json"
...
$manifestObj = [ordered]@{
    ...
    dictamen = "PASS (RELEASE CANDIDATE V0.4.0-ALPHA.2 - FASE B COMPONENT ARCHITECTURE)"
}
