# Script PowerShell para la creación determinista e inmutable de politica-canon-v0.4.0-alpha.4.zip y MANIFEST_v0.4.0-alpha.4.json
$ErrorActionPreference = "Stop"

$version = "0.4.0-alpha.4"
$zipName = "politica-canon-v0.4.0-alpha.4.zip"
$rootDir = "politica-canon-v0.4.0-alpha.4"
$manifestName = "MANIFEST_v0.4.0-alpha.4.json"
...
# Re-calcular la lista completa de archivos en el zip (incluyendo RELEASE_FILES.json recién creado)
...
$manifestObj = [ordered]@{
    ...
    dictamen = "PASS (RELEASE CANDIDATE V0.4.0-ALPHA.4 - FASE C INSTITUTIONAL LANGUAGE & UX)"
}
